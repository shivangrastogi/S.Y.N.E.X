...
from PyQt5.QtWidgets import (QDialog, QVBoxLayout, QHBoxLayout, QPushButton, QLabel, 
                             QFileDialog, QWidget, QMenu, QInputDialog, QMessageBox, QRubberBand, QAction)
from PyQt5.QtCore import Qt, pyqtSignal, QSize, QPoint, QRect, QBuffer, QByteArray, QIODevice
from PyQt5.QtGui import QPixmap, QPainter, QColor, QPainterPath, QIcon, QRegion, QBrush, QPen
import os
import json
...
class UserAvatarWidget(QWidget):
    ...
    def change_picture(self):
        ...
        if path:
            ...
            if dlg.exec_() and dlg.cropped_pixmap:
                # Save cropped
                import shutil
    ...
    def paintEvent(self, event):
        ...
        if pixmap_to_draw:
             ...
             scaled = pixmap_to_draw.scaled(target_size, Qt.AspectRatioMode.KeepAspectRatioByExpanding, Qt.SmoothTransformation)
